...
public class Sistema {
	...
	/**
	 * Agrega una Factura al sistema y a la vez analiza si no hay una persona
	 * repetida<br>
	 ...
	 * @throws PersonaExistenteException: Se lanza en el caso que se encuentra que
	 *                                    la persona ingresada sea repetida
	 */
	 ...
	 * <b>Pre: </b>La persona debe ser distinto de cadena vacia y debe existir;Las
	 * cantidades como cantCel,cantTel,cantTv deben ser mayor o igual que cero; El
	 * domicilio no debe ser repetido<br>
	 * <b>Post: </b>Se agrega un servicio mas a la lista de contrataciones<br>
	 * 
	 * @param persona:   Parametro de tipo String que representa al titular de la
	 *                   factura
	 * @param internet:  Parametro de tipo String que representa al servicio de
	 *                   internet que desea contratar
	 * @param cantCel:   Parametro de tipo int que representa a la cantidad de
	 *                   celulares que desea agregar
	 * @param cantTel:   Parametro de tipo int que representa a la cantidad de
	 *                   telefonos que desea agregar
	 * @param cantTV:    Parametro de tipo int que representa a la cantidad de
	 *                   cables TV que desea agregar
	 * @param domicilio: Parametro de tipo Domicilio que representa al domicilio del
	 *                   serivicio asociado
	 * @throws ServicioInternetInvalidoException: Se lanza en el caso de que el
	 *                                            servicio sea invalido
	 * @throws DomicilioInvalidoException:        Se lanza en el caso de que el
	 *                                            domicilio sea invalido
	 */
	public void agregarServicio(String persona, String internet, int cantCel, int cantTel, int cantTV,
			Domicilio domicilio) {
		try {
			this.listaFacturas.get(persona)
					.nuevaContratacion(ContratableFactory.nuevoServicio(internet, cantCel, cantTel, cantTV, domicilio));
	...
	/**
	 * Realiza el cambio de agregado del servicio <b>Pre: </b> El parametro
	 * Direccion debe ser valido y que exista en la factura;El parametro Accion no
	 * debe ser una cadena vacia y debe existir; El parametro Servicio no debe ser
	 * una cadena vacia y debe existir<br>
	 * <b>Post: </b> Se realiza el cambio de agregado del servicio<br>
	 * 
	 * @param direccion: Parametro de tipo String que representa a la direccion del
	 *                   servicio que desea cambiar
	 * @param accion:    Parametro de tipo String que representa a la acción que
	 *                   quiera realizar
	 * @param servicio:  Parametro de tipo String que representa al servicio que
	 *                   desea modificar
	 */
	public void modificarAgregado(String persona, String direccion, String accion, String servicio) { // PRECONDICON
																										// DIRECCION
																										// VALIDA Y QUE
																										// EXISTA EN LA
																										// FACTURA
	...
	/**
	 * Metodo para abonar el total seg�n el medio de pago <b>Pre: </b> El
	 * parametro nombrePersona debe ser distinto de null o cadena vacia;El parametro
	 * tipo debe ser distinto de null y debe existir<br>
	 * <b>Post: </b> Devuelve el valor del total calculado con el porcentaje
	 * aplicado<br>
	 * 
	 * @param nombrePersona: Parametro de tipo String que representa al abonado de
	 *                       la factura
	 * @param tipo:          Parametro de tipo I_Pago que representa al medio de
	 *                       pago
	 */
	...
	/**
	 * Duplica la factura de una persona <b>Pre: </b> El parametro persona debe ser
	 * distinto de cadena vacia<br>
	 * <b>Post: </b> Se muestra la factura duplicada<br>
	 * 
	 * @param persona: Parametro de tipo String que representa al abonado de la
	 *                 factura a duplicar
	 * @throws CloneNotSupportedException: Se lanza en el caso de que no sea posible
	 *                                     clonar
	 */
	...
	/**
	 * Se elimina una contratacion de una lista de contrataciones de una factura que
	 * pertenece a un abonado.<br>
	 * <b>Pre: </b> Los parametros nombrePersona y domicilio debe ser distinto de
	 * null<br>
	 * <b>Post: </b> Se elimino una contratacion ; si la lista de contrataciones
	 * queda vacia, se elimina la factura <br>
	 * 
	 * @param nombrePersona : Parametro de tipo String que representa el nombre de
	 *                      una persona.
	 * @param nombrePersona : Parametro de tipo String que representa el domicilio
	 *                      de una persona.
	 */
	...
	/**
	 * @param persona: Parametro de tipo String que representa al abonado que desee
	 *                 listar su factura, distinto de cadena vacia
